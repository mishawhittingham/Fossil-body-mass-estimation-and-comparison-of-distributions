...
BM_mamms60 = read.csv("C:\\...\\Broadtest50_size60.csv", header = TRUE)
...
write.csv(poutput, "C:\\...\\pvals_broad50Taph_pgls.csv")
write.csv(doutput, "C:\\...\\dvals_broad50Taph_pgls.csv")
write.csv(moutput, "C:\\...\\modes_broad50Taph_pgls.csv")
write.csv(koutput, "C:\\...\\kurts_broad50Taph_pgls.csv")
write.csv(soutput, "C:\\...\\skews_broad50Taph_pgls.csv")
write.csv(aoutput, "C:\\...\\medians_broad50Taph_pgls.csv")
