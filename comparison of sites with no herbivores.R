...
#read csv files of body masses of non-herbivores from modern sites at various sample sizes, as well as the fossil body mass distibutions

BM_mamms = read.csv("C:\\Wirc\\Projekt3\\Bigness\\subsets\\TetBMs_NoHerbsTaphready.csv", header = TRUE)
BM_mamms20 = read.csv("C:\\Wirc\\Projekt3\\Bigness\\subsets\\TetBMs_NoHerbsTaphready_size20.csv", header = TRUE)
BM_mamms40 = read.csv("C:\\Wirc\\Projekt3\\Bigness\\subsets\\TetBMs_NoHerbsTaphready_size40.csv", header = TRUE)
BM_mamms60 = read.csv("C:\\Wirc\\Projekt3\\Bigness\\subsets\\TetBMs_NoHerbsTaphready_size60.csv", header = TRUE)
...
soutput[1:(sites60*100),12] = allbaseskews60
...
write.csv(poutput, "C:\\Wirc\\Projekt3\\Bigness\\subsets\\pvals_noherbsTaph_pgls.csv")
write.csv(doutput, "C:\\Wirc\\Projekt3\\Bigness\\subsets\\dvals_noherbsTaph_pgls.csv")
write.csv(moutput, "C:\\Wirc\\Projekt3\\Bigness\\subsets\\modes_noherbsTaph_pgls.csv")
write.csv(koutput, "C:\\Wirc\\Projekt3\\Bigness\\subsets\\kurts_noherbsTaph_pgls.csv")
write.csv(soutput, "C:\\Wirc\\Projekt3\\Bigness\\subsets\\skews_noherbsTaph_pgls.csv")
write.csv(aoutput, "C:\\Wirc\\Projekt3\\Bigness\\subsets\\medians_noherbsTaph_pgls.csv")
